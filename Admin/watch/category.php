<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($stmt->execute()) {
            $message = $brandId > 0 ? "Category updated successfully" : "Category added successfully";
       ...
       <!-- Sidebar -->
        ...
        <main class="w-full max-w-4xl p-6 mt-3 mx-auto">
            ...
            <?php
                ...
                $sql = "SELECT id, name, status FROM category LIMIT $limit OFFSET $offset";
                $result = $conn->query($sql);
            ?>

            <h1 class="text-xl font-semibold mb-6">Manage Categories</h1>
            <!-- Success Message -->
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <nav class="text-sm text-gray-500">
                    <a href="./dashboard.php" class="hover:underline">Home</a> &gt; <span>Category</span>
                </nav>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full bg-white border border-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-4 py-2 border-b text-left text-sm font-semibold text-gray-900">Company Name</th>
            ...
            <div id="addBrandModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50" style="display: none;">
                <div class="bg-white w-1/3 rounded-lg shadow-lg p-6">
                    ...
                    <form id="brandForm" action="category.php" method="POST">
                        <div class="mb-4">
                            <label for="brandName" class="block text-sm font-semibold mb-2">Company Name</label>
                            ...
                            <p class="text-red-500 text-sm mt-1 hidden" id="brandNameError">The company name field is required.</p>
                        </div>
            ...
            <div id="editBrandModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50" style="display: none;">
                <div class="bg-white w-1/3 rounded-lg shadow-lg p-6">
                    ...
                    <form id="editBrandForm" method="POST" action="category.php?action=edit">
                        <input type="hidden" id="brandId" name="id" value=""> <!-- Hidden field for the brand ID -->
                        
                        <div class="mb-4">
                            <label for="editBrandName" class="block text-sm font-semibold mb-2">Company Name</label>
                            ...
                            <p class="text-red-500 text-sm mt-1 hidden" id="editBrandNameError">The company name field is required.</p>
                        </div>
            ...
            <div id="deleteBrandModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center" style="display: none;" >
                <div class="bg-white rounded-lg w-96 p-4">
                    <div class="flex justify-between items-center py-1 mb-1">
                        <h3 class="text-lg font-semibold">Remove Category</h3>
...
<script>
    ...
    confirmDeleteBtn.addEventListener('click', () => {
        if (currentBrandId) {
            ...
            fetch(`category.php?action=delete`, {
                method: 'POST',
                headers: {
